                    ...
                    <div className="w-full sm:w-1/2">
                        <div className="flex flex-col">
                            <div className="one mb-5 sm:mb-10">
                                <p className="text-[clamp(1rem,2vw,1.35rem)] font-light">
                                    {overview}
                                </p>
                            </div>
                            ...
                            <div className="goals flex border-b-1 pt-5 pb-10">
                                ...
                                <div className=" w-1/2 text-[clamp(1rem,2vw,1.35rem)] font-light">
                                    {projectGoals}
                                </div>
                            </div>
                                ...
                                <div className=" w-1/2">
                                    {
                                        softSkill.map((skill, idx) => (
                                            <div key={idx}>
                                                <p className="text-[clamp(1rem,2vw,1.35rem)] font-light">{skill}</p>
                                            </div>
                                        ))
                                    }
                                </div>
                                ...
                                <div className=" w-1/2">
                                    {
                                        tech.map((tool, idx) => (
                                            <div key={idx}>
                                                <p className="text-[clamp(1rem,2vw,1.35rem)] font-light">{tool}</p>
                                            </div>
                                        ))
                                    }
                                </div>
